    ...
    <footer className="bg-gray-50 dark:bg-gray-900 border-t">
      <div className="container px-4 py-12 md:py-16 md:px-6">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
          <div className="space-y-4">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">
              Sustainable transportation solutions for a greener future. Reducing carbon emissions through AI-powered
              route optimization.
            </p>
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-col space-y-2">
              ...
              <div className="flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400">
                ...
                <span>info@ecotransport.com</span>
              </div>
            </div>
          </div>
          <div className="space-y-4">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">
              Subscribe to our newsletter for the latest updates on sustainable transportation.
            </p>
            <div className="flex flex-col space-y-2">
        ...
        <div className="mt-12 border-t pt-8 text-center text-sm text-gray-500 dark:text-gray-400">
          <p>© {new Date().getFullYear()} EcoTransport. All rights reserved.</p>
          <p className="mt-2">
            <Link href="/privacy-policy" className="hover:underline">
              Privacy Policy
            </Link>{" "}
            |
            <Link href="/terms-of-service" className="hover:underline ml-2">
              Terms of Service
            </Link>
          </p>
        </div>
